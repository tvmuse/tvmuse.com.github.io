...
<head>
    ...
    <meta name="keywords" content="<?php echo $row['name'];?>,<?php echo $keywords;?>">
        ...
        <div class="col-md-12">
              ...
              <div class="vcontainer">
                                <div id="streaming" data-toggle="modal" data-target="#modal-watch">
                                        ...
                                        <div class="watermark"><?php echo $config->title;?></div>
                ...
                <div class="row" style="margin-top:25px;">
                        <center><div class="available-formats-img-mobile"><img src="http://tvmuze.biz/img/download/available-formats-img.png" class="img-responsive"> </div></center>
                </div>
                <div class="row" style="margin-top:25px;">
                    <div> <center> <h4 class="modal-title" id="myModalLabel"><b>Please Click Button Here to Watch <?php echo $row['name'];?><?php echo $movie_title;?> Full Streaming</b></center></div>
                    <center>
                        <tr>
...
<div class="modal fade" id="modal-watch" tabindex="-1" role="dialog" aria-labelledby="modal-watch" aria-hidden="true">
        ...
        <div class="modal-content clearfix">
                <div class="modal-header bg-info">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Please Sign Up To Watch <?php echo $row['name'];?><?php echo $movie_title;?> Full Streaming!</h4>
                </div>
