				...
				<div class="col-md-2 col-sm-4 col-xs-6">
					<div class="movie-list text-center" data-toggle="tooltip" data-placement="top" title="<?php echo $row['original_name'];?>">
						<a href="<?php echo $_ocim->home_url();?>/desc/play.php?id=<?php echo $row['id'];?>">
							<div class="thumbnail"><img src="<?php echo $image;?>" alt="<?php echo $row['original_name'];?>" class="img-responsive"></div>

							<div class="movie-list-title nowrap"><?php echo $row['name'];?></div>
                                                </a>
